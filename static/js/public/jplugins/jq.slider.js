...
(function($) {
	$.fn.jjSlider = function(options) {
		var opts = $.extend({}, $.fn.jSlider.deflunt, options);
		var index = 1;
		...
		return this.each(function() {
			...
			clickNext.click(function(event) {
				$.fn.jSlider.effectLoop.scroolLeft(ContentBox, targetLi, index, slideWH, opts, function() {
			...
			clickPrev.click(function(event) {
				...
				$.fn.jSlider.effectLoop.scroolRight(ContentBox, targetLi, index, slideWH, opts);
				event.preventDefault();
			});
			//自动播放
			if (opts.autoPlay) {
